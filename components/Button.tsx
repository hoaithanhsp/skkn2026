...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "border-transparent text-sky-700 bg-sky-100 hover:bg-sky-200 focus:ring-sky-500",
    outline: "border-sky-300 text-sky-700 bg-white hover:bg-sky-50 focus:ring-sky-500",
